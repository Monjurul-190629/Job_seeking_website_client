        ...
        <div className="">
            ...
            <div className="hero min-h-screen">
                ...
                <div className="hero-content flex-col lg:flex-row-reverse ">
                    <div className="card shrink-0 w-full  shadow-2xl bg-gradient-to-r from-slate-400 to-slate-400 px-5 md:px-20 py-10">
                        <form className="card-body text-slate-900 font-bold" onSubmit={handleAddJob} >
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-3 gap-10'>
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text text-slate-900">Job Category</span>
                                    </label>
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text text-slate-800">Job description</span>
                                    </label>
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text text-slate-800">Job Posting Date</span>
                                    </label>
                                ...
                                <div className='form-control'>
                                    <label className='label'>
                                        <span className='label-text text-slate-800'>Application Deadline</span>
                                    </label>
                                ...
                                <div className="form-control">
                                    <label className="label">
                                        <span className="label-text text-slate-800">Job Applicants Number</span>
                                    </label>
                            ...
                            <div className="form-control mt-10">
                                <button className="btn bg-white hover:bg-slate-800 font-bold hover:text-white text-black">Add</button>
                            </div>
