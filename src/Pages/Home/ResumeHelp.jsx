...
const ResumeHelp = () => {
    return (
        <div className='mt-20'>
            <div className="flex flex-col-reverse md:flex-row rounded-2xl items-center justify-center bg-gradient-to-r from-sky-700 to-blue-500 mx-4 lg:mx-20 mt-10 md:mt-28 p-4">
                <div className="md:px-10 lg:px-20 md:py-5 lg:py-10 text-justify md:text-left">
                    <p>
                        <span className="text-slate-200 text-xl md:text-3xl font-semibold pt-5">Need help with your resume?<br /></span>
